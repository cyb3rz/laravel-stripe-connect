                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="cc_number" placeholder="Your card number"
                                            class="form-control" value="4242424242424242" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" pattern="/^-?\d+\.?\d*$/"
                                                    ...
                                                    name="year" class="form-control" value="2024" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group mb-4">
                                            ...
                                            <input type="text" name="cvv" required class="form-control" value="342">
                                        </div>
                                    </div>
